...
const StyledFooterInner = styled.div`
  ...
  h2{
    ...
    width: 120px;
    height: 60px;
    background: url(http://ppaxe.kr/web/contents/images/common/footer_logo.png) center center no-repeat;
...
const StyledSnsLink = styled.a.attrs({
    ...
    height: 40px;
    display: block;
    background: url(http://ppaxe.kr/web/contents/images/common/footer_sns.png) center center no-repeat;
