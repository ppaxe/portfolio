...
const Data = {
    ...
    [
        ...
        },
        {
            ...
            title : 'Web',
            kor : 'PC 포트폴리오',
            redirect : (device) => { return device === 'pc' ? window.open('https://ppaxe.kr/web/') : window.open('https://ppaxe.kr/mobile/') },
            active : false,
            zIndex : 0,
        },
        {
            ...
            title : 'Mobile',
            kor : '모바일 포트폴리오',
            redirect : (device) => { return device === 'pc' ? window.open('https://ppaxe.kr/mobile/','_blank','width=414, height=736') : window.open('https://ppaxe.kr/mobile/') },
            active : false,
            zIndex : 0,
        },
        {
